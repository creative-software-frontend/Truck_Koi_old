    ...
    return (
        <div className="max-w-screen-xl mx-auto px-4">
            ...
            <div className="flex border-b border-gray-200 mb-8">
                ...
                >
                    চলতি ট্রিপ
                    {activeTab === "current" && <div className="absolute bottom-0 left-0 w-full h-0.5 bg-red-600" />}
                </button>
                <button
                ...
                >
                    ট্রিপ হিস্টরি
                    {activeTab === "history" && <div className="absolute bottom-0 left-0 w-full h-0.5 bg-red-600" />}
                </button>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-16">
                ...
                <h2 className="text-xl text-gray-900 mb-6">বর্তমানে আপনার কোনো ট্রিপ নেই</h2>
